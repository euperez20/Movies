...
<!-- 
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/carousel/3.jpg" class="d-block w-100" alt="1.jpg">
    </div>
    <div class="carousel-item">
      <img src="images/carousel/1.jpg" class="d-block w-100" alt="2.jpg">
    </div>
    <div class="carousel-item">
      <img src="images/carousel/2.jpg" class="d-block w-100" alt="3.jpg">
    </div>
  </div>
...
<table class="table">
  ...
  <tbody>    
    ...
    while($row = $statement->fetch(PDO::FETCH_ASSOC)){
        ...
        <th scope="row"><?php echo "<h3><p class=title><a class=edit href='" . "select.php?movieId" . "=" . $row['movieId'] . "'" . ">" . $row['title'] . " (" . $row['releaseYear'] . ")</a></h3>" ;  ?> </th> 
           
        </tr>
        <td> <?php echo "<h3><p class=title><a class=edit href='" . "select.php?movieId" . "=" . $row['director'] ;  ?> </td>  

...
// Assign values  
  ...
  // Add table headers
  const headers = ["Park Name", "Location", "Category", "District", "Neighbourhood"];
  ...
  data.forEach(item => {
    ...
    const values = [item.park_name, item.location_description, item.park_category, item.district, item.neighbourhood];
